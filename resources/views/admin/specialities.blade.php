                    ...
                    <div class="card mt-2 mx-auto p-4 bg-light">
                        <div class="card-body bg-light">
                            <div class="container">
                                <h2>Specialities</h2>
                                <div class="col-lg-2">
                                    <a href="{{ route('speciality.new_form') }}" class="btn btn-primary">Add New Speciality</a>
                                </div>
                                <table class="table table-striped">
                                    ...
                                    @forelse($specialities as $speciality)
                                        <tr>
                                            <td>{{ $speciality->specialty_name }}</td>
                                            <td>{{ $speciality->description }}</td>
                                            <td>
                                                <a href="{{ route('specialities.edit', $speciality) }}" class="btn-primary btn-sm">
